...
namespace Discord.Tests
{
    ...
    public class Tests
    {
        ...
        public static void Initialize(TestContext testContext)
        {
            ...
            HostBotToken = "MTk2Mjg3NjAwMzA5MzA1MzQ0.C1wCUw.8XYNQuWFsRI20yCcgiJwDApG0Q8"; //Environment.GetEnvironmentVariable("discord-unit-host_token");
            ObserverBotToken = Environment.GetEnvironmentVariable("discord-unit-observer_token");
            TargetEmail = "bot.SC2@gmail.com";//Environment.GetEnvironmentVariable("discord-unit-target_email");
            TargetPassword = "8maW>$gG83";// Environment.GetEnvironmentVariable("discord-unit-target_pass");
        }
